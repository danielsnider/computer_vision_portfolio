...
int AreaSum(Mat I, int x1, int x2){
// Computes pixel sum of a given range of columns from x1 to x2
...
vector<Mat> SeperateTermDefV2(Mat I){
//Seperate left column of text (the terms) in an image from the right column of text (the definitions)
