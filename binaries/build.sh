...
g++ -g ./source_files/quiz_it/MyImage.cpp ./source_files/quiz_it/MyFuncs.cpp ./source_files/quiz_it/main.cpp -o ./quizit.out `pkg-config --cflags opencv` `pkg-config --libs opencv`
